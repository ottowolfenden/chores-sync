...
section.addEventListener("open", async () => {
    ...
    message.elsToHide = [countsList, section.querySelector("button#expand-all")];
    ...
    if (counts == null) message.status = "error";
        ...
        //         ".total-count .num": count.memberCounts.reduce(
        ...
        //         const clone = choreDetailsLITemplate.content.cloneNode(
        //             true
        //         ) as DocumentFragment;
        ...
        //     const numText = detailsListItem.querySelector(
        //         ".count-text .num"
        //     ) as HTMLSpanElement;
        ...
        //     evalTotal(listItem);
        //     const newOffset =
        //         parseInt(offsetNum.textContent == "" ? "0" : offsetNum.textContent) +
        //         difference;
